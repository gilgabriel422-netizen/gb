...
export default CobranzasPanel
  ...
  const handleSavePayment = async () => {
    try {
      ...
      if (parseFloat(paymentFormData.payment_amount) <= 0) {
  ...
  const handleSaveAgreement = async () => {
    try {
      ...
      if (!agreementFormData.total_amount || parseFloat(agreementFormData.total_amount) <= 0) {
        alert('Por favor, ingresa un monto total válido para el convenio')
        return
      }
      if (!agreementFormData.installment_count || parseInt(agreementFormData.installment_count) <= 0) {
        alert('Por favor, ingresa un número de cuotas válido')
        return
      }
      if (!agreementFormData.start_date) {
        alert('Por favor, selecciona la fecha de inicio')
        return
      }
      if (!agreementFormData.payment_method || agreementFormData.payment_method.trim() === '') {
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg shadow-md text-black">
          {/* Aquí van las notificaciones del día, sin modal de pago */}
        </div>
        ...
        {/* Resumen del PerÃ­odo Actual */}
        <div className="bg-gradient-to-r from-yellow-100 via-yellow-200 to-yellow-400 p-6 rounded-lg shadow-md text-black">
        ...
        <div className="bg-gradient-to-r from-yellow-50 via-yellow-100 to-yellow-300 p-6 rounded-lg shadow-md text-black">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 flex items-center">
      ...
      {/* Resumen ejecutivo */}
      <div className="bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-600 text-black p-6 rounded-lg">
  ...
  const renderClients = () => (
    <div className="space-y-6">
      ...
      <div className="rounded-lg shadow overflow-hidden bg-gradient-to-r from-yellow-50 via-yellow-100 to-yellow-300 text-black">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-gradient-to-r from-yellow-100 via-yellow-50 to-yellow-100 divide-y divide-gray-200 text-black">
              {loading ? (
                <tr>
        ...
        {!loading && totalClients > 0 && (
          <div className="bg-gradient-to-r from-yellow-100 via-yellow-50 to-yellow-200 px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6 text-black">
              ...
              <div>
                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                  <button
                    ...
                    disabled={currentPage === 1}
                    className={`relative inline-flex items-center px-2 py-2 rounded-l-md border border-transparent bg-yellow-50 text-sm font-medium ${
                      currentPage === 1
                      ...
                      <button
                        ...
                        className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                          currentPage === pageNum
                            ...
                            : 'bg-yellow-50 border-transparent text-black hover:bg-yellow-100'
                        }`}
                      >
                        {pageNum}
                      </button>
                  ...
                  <button
                    ...
                    disabled={currentPage === totalPages}
                    className={`relative inline-flex items-center px-2 py-2 rounded-r-md border border-transparent bg-yellow-50 text-sm font-medium ${
                      currentPage === totalPages
  ...
  const renderPayments = () => (
    <div className="space-y-6">
        ...
        <button onClick={handleOpenPaymentCreator} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleOpenAgreementCreator} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
            <Plus size={16} className="inline mr-2" />
            Agregar Convenio
          </button>
        </div>
  ...
  const renderHistory = () => (
    <div className="space-y-6">
      ...
      {/* Filtros */}
      <div className="bg-gradient-to-r from-yellow-50 via-yellow-100 to-yellow-300 p-4 rounded-lg shadow-sm border text-black">
      ...
      {collectionsHistoryLoading ? (
        ...
        <div className="space-y-4">
          ...
          {collectionsHistoryData.report
            ...
            .map((clientData) => (
              <div key={clientData.client.id} className="bg-gradient-to-r from-yellow-100 via-yellow-200 to-yellow-400 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow text-black">
        ...
        <div className="bg-gradient-to-r from-yellow-100 via-yellow-200 to-yellow-400 p-6 rounded-lg shadow-md text-black">
          <p className="text-gray-700 text-center py-4">No se encontraron datos de historial</p>
        </div>
      )}
    </div>
  )
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-yellow-200 via-yellow-100 to-yellow-50 shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 text-black`}>
        ...
        <nav className="mt-6">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center px-3 py-2 text-sm font-medium text-black hover:bg-yellow-100 hover:text-black rounded-md"
          >
      ...
      <div className="lg:pl-64">
        {/* Mobile Header */}
        <div className="lg:hidden bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-50 shadow">
    ...
    {showClientDetails && selectedClient && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
    ...
    {showPaymentModal && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black w-full max-w-md">
          ...
          <form className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  const selectedClient = adminClients.find(c => c.id === parseInt(e.target.value))
                  setPaymentFormData({
                    ...paymentFormData,
    ...
    {/* Modal de agregar convenio */}
      {showPaymentClientSelector && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black w-full max-w-2xl mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold">Seleccionar Cliente para Pago</h3>
              <button onClick={() => setShowPaymentClientSelector(false)} className="text-gray-400 hover:text-gray-600"><X className="h-6 w-6" /></button>
            </div>
            <div className="space-y-2">
              {adminClients.length === 0 ? (
                <p className="text-sm text-gray-500">No hay clientes creados por admin@crm.com disponibles.</p>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {adminClients.map(c => (
                    <div key={c.id} className="p-3 border border-yellow-200 rounded hover:bg-yellow-100 flex justify-between items-center">
                      <div>
                        <div className="font-semibold">{c.first_name} {c.last_name}</div>
                        <div className="text-sm text-gray-600">{c.contract_number || 'Sin contrato'}</div>
                      </div>
                      <div>
                        <button onClick={() => handleSelectClientForPayment(c)} className="px-3 py-1 bg-blue-600 text-white rounded">Seleccionar</button>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      {showAgreementClientSelector && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black w-full max-w-2xl mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold">Seleccionar Cliente para Convenio</h3>
              <button onClick={() => setShowAgreementClientSelector(false)} className="text-gray-400 hover:text-gray-600"><X className="h-6 w-6" /></button>
            </div>
            <div className="space-y-2">
              {clients.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {clients.map(c => (
                    <div key={c.id} className="p-3 border border-yellow-200 rounded hover:bg-yellow-100 flex justify-between items-center">
                      ...
                      <div>
                        <button onClick={() => handleSelectClientForAgreement(c)} className="px-3 py-1 bg-blue-600 text-white rounded">Seleccionar</button>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setAgreementFormData({...agreementFormData, payment_method: e.target.value})}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="">Seleccionar...</option>
                <option value="Transferencia">Transferencia</option>
    ...
    {showManagementHistoryModal && selectedClientForHistory && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            <div>
          ...
          {loadingManagements ? (
                    ...
                    <>
                      ...
                      <div className="space-y-3">
                        {clientManagements.map((management, index) => (
                          <div key={management.id || index} className="border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100">
                            <div className="flex justify-between items-start mb-2">
                              <div className="flex items-center gap-2">
                  ...
                  {clientHistoryData?.history?.filter(h => h.type === 'payment').length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {clientHistoryData?.history?.filter(h => h.type === 'payment').map((payment, index) => (
                        <div key={payment.id || index} className="border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center gap-2">
                  ...
                  {clientHistoryData?.history?.filter(h => h.type === 'agreement').length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {clientHistoryData?.history?.filter(h => h.type === 'agreement').map((agreement, index) => (
                        <div key={agreement.id || index} className="border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-yellow-100 text-black rounded-lg hover:bg-yellow-200"
            >
              Cerrar
            </button>
          </div>
    ...
    {showClientHistoryModal && selectedClientForHistory && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 p-6 rounded-lg text-black w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            <div>
            ...
            <div className="space-y-4">
              ...
              {clientHistoryData.history && clientHistoryData.history.length > 0 ? (
                clientHistoryData.history.map((item, index) => (
                  <div key={item.id || index} className="border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-2">
